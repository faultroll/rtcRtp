...
int rtsp_codec_data_parse_from_user_g72x(const uint8_t *codec_data, int data_len, struct codec_data_g72x *pst_codec_data);
...
int rtsp_build_sdp_media_attr_g72x(int pt, int sample_rate, const struct codec_data_g72x *pst_codec_data, char *sdpbuf, int maxlen);
